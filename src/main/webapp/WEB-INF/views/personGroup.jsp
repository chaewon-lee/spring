...
<div id="persongrid" style="flex:1"></div>
</div>
<div id="jsgrid"></div>
...
function dataInitialize(){
	person = ${userList};
	group= ${groupList};
	map= ${mapList}; //person group mapping -> group_map_tb
}
...
$(document).ready(function() {
	...
	$("#persongrid").jsGrid({
		...
		fields:[
			...
			{name: "team_id", type: "select", width:100, items: team, valueField: "teamCode", textField: "ItemName", validate: {message:	"팀을 선택하십시오.",	validator: function(value) {return true;}}},
	...
	$("#jsgrid").jsGrid({ //권한 클릭 시 테이블에 권한-사번 mapping 띄우기
		...
		fields:[
			{name: "group_id", type: "text", width:100 }, 
			{name: "person", type: "text", width:100},
			{type: "control", editButton: false}
		]
	});
});
